...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateLMResults(data) {
        ...
        setTimeout(() => {
            ...
            document.getElementById('lm-training-progress').innerHTML = `
                <h5>Progress Pelatihan</h5>
                <div class="progress mb-3">
                    <div class="progress-bar bg-success" role="progressbar" style="width: 100%" 
                         aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">100%</div>
                </div>
                <p>Algoritma Levenberg-Marquardt telah selesai dijalankan.</p>
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            <th>Metrik</th>
            ...
            setTimeout(() => {
                ...
                document.querySelector('#lmStepTabs a[href="#lm-step4"]').click();
    ...
    function updateRNNResults(data) {
        // Navigate to data preparation step
        ...
        setTimeout(() => {
            ...
            document.getElementById('rnn-training-progress').innerHTML = `
                ...
                <p>Model RNN telah selesai dilatih dengan ${data.history.epochs.length - 1} epochs.</p>
            `;
            ...
            setTimeout(() => {
                // Navigate to results step
                document.querySelector('#rnnStepTabs a[href="#rnn-step4"]').click();
